const terminalItems = [
    {
        title: "Manifesto",
        content: "The Cypherpunk legacy was built to defend digital sovereignty and privacy.\nIt's 2025, and surveillance capitalism is more invasive than ever —accelerating and eroding our fundamental rights.\nIt's time to act. To preserve what it means to be human in the Information Age.\nW3PN_Hacks welcomes all skilled individuals from diverse fields to develop the tools to safeguard personal privacy. Tools that are accessible and intuitive for everyone.\n\nWe embrace a bounty-agnostic approach: use the best tool for the job.\n\nWe encourage open collaboration: work shoulder to shoulder with someone that has complementary skills and knowledge. Only together, uniting different perspectives and backgrounds we can shape a future where digital privacy and safety are paramount.\n\nWe are the next wave of Cypherpunks, committed to building practical tools for digital freedom.\n\nJoin us.",
        subItems: [
            {
